...
// Macro to enforce StateObj inheritance and generate both nlohmann and StateObj
// methods
#define STATE_OBJ_DEFINE_TYPE(Type, ...)                                       \
  static_assert(std::is_base_of_v<::StateManager::StateObj, Type>,             \
                #Type " must inherit from StateObj");                          \
